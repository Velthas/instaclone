...
const createUser = async (mail: string, password: string, username: string, setUser: (user: FirebaseUser | null) => void) => {
...
const authenticationListener = (setUser: (user: FirebaseUser | null) => void) => {
